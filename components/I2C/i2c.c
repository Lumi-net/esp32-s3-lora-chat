...
#define I2C_MASTER_SDA_IO GPIO_NUM_42
...
const battery_table_t battery_table[] = {
    {4.20, 100}, {4.15, 95}, {4.11, 90}, {4.08, 80}, {4.02, 70}, {3.98, 60}, {3.95, 50}, {3.91, 40}, {3.87, 30}, {3.83, 20}, {3.79, 10}, {3.70, 5}, {3.30, 0}};
